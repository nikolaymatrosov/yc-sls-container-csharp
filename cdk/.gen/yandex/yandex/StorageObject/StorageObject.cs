...
{
    /// <summary>Represents a {@link https://www.terraform.io/docs/providers/yandex/r/storage_object yandex_storage_object}.</summary>
    [JsiiClass(nativeType: typeof(yandex.StorageObject.StorageObject), fullyQualifiedName: "yandex.storageObject.StorageObject", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"remarks\":\"Must be unique amongst siblings in the same scope\",\"summary\":\"The scoped construct ID.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"yandex.storageObject.StorageObjectConfig\"}}]")]
    public class StorageObject : HashiCorp.Cdktf.TerraformResource
    {
        /// <summary>Create a new {@link https://www.terraform.io/docs/providers/yandex/r/storage_object yandex_storage_object} Resource.</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        /// <param name="id">The scoped construct ID.</param>
        public StorageObject(Constructs.Construct scope, string id, yandex.StorageObject.IStorageObjectConfig config): base(_MakeDeputyProps(scope, id, config))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(Constructs.Construct scope, string id, yandex.StorageObject.IStorageObjectConfig config)
        {
        ...
        protected StorageObject(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected StorageObject(DeputyProps props): base(props)
        {
        }
        ...
        = GetStaticProperty<string>(typeof(yandex.StorageObject.StorageObject))!;
