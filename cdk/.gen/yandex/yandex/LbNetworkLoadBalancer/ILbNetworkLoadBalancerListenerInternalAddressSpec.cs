...
{
    [JsiiInterface(nativeType: typeof(ILbNetworkLoadBalancerListenerInternalAddressSpec), fullyQualifiedName: "yandex.lbNetworkLoadBalancer.LbNetworkLoadBalancerListenerInternalAddressSpec")]
    public interface ILbNetworkLoadBalancerListenerInternalAddressSpec
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ILbNetworkLoadBalancerListenerInternalAddressSpec), fullyQualifiedName: "yandex.lbNetworkLoadBalancer.LbNetworkLoadBalancerListenerInternalAddressSpec")]
        internal sealed class _Proxy : DeputyBase, yandex.LbNetworkLoadBalancer.ILbNetworkLoadBalancerListenerInternalAddressSpec
        {
