...
{
    [JsiiByValue(fqn: "yandex.lbNetworkLoadBalancer.LbNetworkLoadBalancerConfig")]
    public class LbNetworkLoadBalancerConfig : yandex.LbNetworkLoadBalancer.ILbNetworkLoadBalancerConfig
    {
        private object? _attachedTargetGroup;
