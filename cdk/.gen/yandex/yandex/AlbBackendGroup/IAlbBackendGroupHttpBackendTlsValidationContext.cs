...
{
    [JsiiInterface(nativeType: typeof(IAlbBackendGroupHttpBackendTlsValidationContext), fullyQualifiedName: "yandex.albBackendGroup.AlbBackendGroupHttpBackendTlsValidationContext")]
    public interface IAlbBackendGroupHttpBackendTlsValidationContext
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IAlbBackendGroupHttpBackendTlsValidationContext), fullyQualifiedName: "yandex.albBackendGroup.AlbBackendGroupHttpBackendTlsValidationContext")]
        internal sealed class _Proxy : DeputyBase, yandex.AlbBackendGroup.IAlbBackendGroupHttpBackendTlsValidationContext
        {
