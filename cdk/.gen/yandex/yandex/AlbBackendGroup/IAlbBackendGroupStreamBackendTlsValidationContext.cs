...
{
    [JsiiInterface(nativeType: typeof(IAlbBackendGroupStreamBackendTlsValidationContext), fullyQualifiedName: "yandex.albBackendGroup.AlbBackendGroupStreamBackendTlsValidationContext")]
    public interface IAlbBackendGroupStreamBackendTlsValidationContext
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IAlbBackendGroupStreamBackendTlsValidationContext), fullyQualifiedName: "yandex.albBackendGroup.AlbBackendGroupStreamBackendTlsValidationContext")]
        internal sealed class _Proxy : DeputyBase, yandex.AlbBackendGroup.IAlbBackendGroupStreamBackendTlsValidationContext
        {
