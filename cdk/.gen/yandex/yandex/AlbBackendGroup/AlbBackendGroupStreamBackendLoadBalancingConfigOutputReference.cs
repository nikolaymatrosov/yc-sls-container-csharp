...
{
    [JsiiClass(nativeType: typeof(yandex.AlbBackendGroup.AlbBackendGroupStreamBackendLoadBalancingConfigOutputReference), fullyQualifiedName: "yandex.albBackendGroup.AlbBackendGroupStreamBackendLoadBalancingConfigOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktf.IInterpolatingParent\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}}]")]
    public class AlbBackendGroupStreamBackendLoadBalancingConfigOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        public AlbBackendGroupStreamBackendLoadBalancingConfigOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
        ...
        protected AlbBackendGroupStreamBackendLoadBalancingConfigOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected AlbBackendGroupStreamBackendLoadBalancingConfigOutputReference(DeputyProps props): base(props)
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"yandex.albBackendGroup.AlbBackendGroupStreamBackendLoadBalancingConfig\"}", isOptional: true)]
        public virtual yandex.AlbBackendGroup.IAlbBackendGroupStreamBackendLoadBalancingConfig? InternalValue
        {
