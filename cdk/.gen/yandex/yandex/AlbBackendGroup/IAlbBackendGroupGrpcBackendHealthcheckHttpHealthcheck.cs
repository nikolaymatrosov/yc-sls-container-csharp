...
{
    [JsiiInterface(nativeType: typeof(IAlbBackendGroupGrpcBackendHealthcheckHttpHealthcheck), fullyQualifiedName: "yandex.albBackendGroup.AlbBackendGroupGrpcBackendHealthcheckHttpHealthcheck")]
    public interface IAlbBackendGroupGrpcBackendHealthcheckHttpHealthcheck
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IAlbBackendGroupGrpcBackendHealthcheckHttpHealthcheck), fullyQualifiedName: "yandex.albBackendGroup.AlbBackendGroupGrpcBackendHealthcheckHttpHealthcheck")]
        internal sealed class _Proxy : DeputyBase, yandex.AlbBackendGroup.IAlbBackendGroupGrpcBackendHealthcheckHttpHealthcheck
        {
