...
{
    [JsiiByValue(fqn: "yandex.albBackendGroup.AlbBackendGroupConfig")]
    public class AlbBackendGroupConfig : yandex.AlbBackendGroup.IAlbBackendGroupConfig
    {
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case null:
                            break;
                        default:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(yandex.AlbBackendGroup.IAlbBackendGroupHttpBackend).FullName}[]; received {value.GetType().FullName}", nameof(value));
                    }
                }
                _httpBackend = value;
            }
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case null:
                            break;
                        default:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(yandex.AlbBackendGroup.IAlbBackendGroupStreamBackend).FullName}[]; received {value.GetType().FullName}", nameof(value));
                    }
                }
                _streamBackend = value;
            }
        }
