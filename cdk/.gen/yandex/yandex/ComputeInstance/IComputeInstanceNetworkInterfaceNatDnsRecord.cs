...
{
    [JsiiInterface(nativeType: typeof(IComputeInstanceNetworkInterfaceNatDnsRecord), fullyQualifiedName: "yandex.computeInstance.ComputeInstanceNetworkInterfaceNatDnsRecord")]
    public interface IComputeInstanceNetworkInterfaceNatDnsRecord
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IComputeInstanceNetworkInterfaceNatDnsRecord), fullyQualifiedName: "yandex.computeInstance.ComputeInstanceNetworkInterfaceNatDnsRecord")]
        internal sealed class _Proxy : DeputyBase, yandex.ComputeInstance.IComputeInstanceNetworkInterfaceNatDnsRecord
        {
