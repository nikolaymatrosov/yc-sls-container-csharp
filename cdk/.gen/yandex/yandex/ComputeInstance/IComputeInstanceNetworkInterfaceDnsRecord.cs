...
{
    [JsiiInterface(nativeType: typeof(IComputeInstanceNetworkInterfaceDnsRecord), fullyQualifiedName: "yandex.computeInstance.ComputeInstanceNetworkInterfaceDnsRecord")]
    public interface IComputeInstanceNetworkInterfaceDnsRecord
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IComputeInstanceNetworkInterfaceDnsRecord), fullyQualifiedName: "yandex.computeInstance.ComputeInstanceNetworkInterfaceDnsRecord")]
        internal sealed class _Proxy : DeputyBase, yandex.ComputeInstance.IComputeInstanceNetworkInterfaceDnsRecord
        {
