...
{
    [JsiiInterface(nativeType: typeof(IComputeInstanceNetworkInterfaceIpv6DnsRecord), fullyQualifiedName: "yandex.computeInstance.ComputeInstanceNetworkInterfaceIpv6DnsRecord")]
    public interface IComputeInstanceNetworkInterfaceIpv6DnsRecord
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IComputeInstanceNetworkInterfaceIpv6DnsRecord), fullyQualifiedName: "yandex.computeInstance.ComputeInstanceNetworkInterfaceIpv6DnsRecord")]
        internal sealed class _Proxy : DeputyBase, yandex.ComputeInstance.IComputeInstanceNetworkInterfaceIpv6DnsRecord
        {
