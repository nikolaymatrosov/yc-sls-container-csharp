...
namespace yandex.AlbVirtualHost
{
    ...
    [JsiiByValue(fqn: "yandex.albVirtualHost.AlbVirtualHostModifyRequestHeaders")]
    public class AlbVirtualHostModifyRequestHeaders : yandex.AlbVirtualHost.IAlbVirtualHostModifyRequestHeaders
    {
