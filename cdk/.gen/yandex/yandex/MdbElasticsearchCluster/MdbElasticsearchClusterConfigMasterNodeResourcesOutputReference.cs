...
{
    [JsiiClass(nativeType: typeof(yandex.MdbElasticsearchCluster.MdbElasticsearchClusterConfigMasterNodeResourcesOutputReference), fullyQualifiedName: "yandex.mdbElasticsearchCluster.MdbElasticsearchClusterConfigMasterNodeResourcesOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktf.IInterpolatingParent\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}}]")]
    public class MdbElasticsearchClusterConfigMasterNodeResourcesOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        public MdbElasticsearchClusterConfigMasterNodeResourcesOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
        ...
        protected MdbElasticsearchClusterConfigMasterNodeResourcesOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected MdbElasticsearchClusterConfigMasterNodeResourcesOutputReference(DeputyProps props): base(props)
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"yandex.mdbElasticsearchCluster.MdbElasticsearchClusterConfigMasterNodeResources\"}", isOptional: true)]
        public virtual yandex.MdbElasticsearchCluster.IMdbElasticsearchClusterConfigMasterNodeResources? InternalValue
        {
