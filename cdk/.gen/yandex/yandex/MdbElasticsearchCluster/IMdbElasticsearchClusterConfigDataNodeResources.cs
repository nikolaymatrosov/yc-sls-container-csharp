...
{
    [JsiiInterface(nativeType: typeof(IMdbElasticsearchClusterConfigDataNodeResources), fullyQualifiedName: "yandex.mdbElasticsearchCluster.MdbElasticsearchClusterConfigDataNodeResources")]
    public interface IMdbElasticsearchClusterConfigDataNodeResources
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IMdbElasticsearchClusterConfigDataNodeResources), fullyQualifiedName: "yandex.mdbElasticsearchCluster.MdbElasticsearchClusterConfigDataNodeResources")]
        internal sealed class _Proxy : DeputyBase, yandex.MdbElasticsearchCluster.IMdbElasticsearchClusterConfigDataNodeResources
        {
