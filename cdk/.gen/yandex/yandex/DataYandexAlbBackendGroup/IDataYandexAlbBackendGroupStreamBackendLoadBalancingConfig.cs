...
{
    [JsiiInterface(nativeType: typeof(IDataYandexAlbBackendGroupStreamBackendLoadBalancingConfig), fullyQualifiedName: "yandex.dataYandexAlbBackendGroup.DataYandexAlbBackendGroupStreamBackendLoadBalancingConfig")]
    public interface IDataYandexAlbBackendGroupStreamBackendLoadBalancingConfig
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataYandexAlbBackendGroupStreamBackendLoadBalancingConfig), fullyQualifiedName: "yandex.dataYandexAlbBackendGroup.DataYandexAlbBackendGroupStreamBackendLoadBalancingConfig")]
        internal sealed class _Proxy : DeputyBase, yandex.DataYandexAlbBackendGroup.IDataYandexAlbBackendGroupStreamBackendLoadBalancingConfig
        {
