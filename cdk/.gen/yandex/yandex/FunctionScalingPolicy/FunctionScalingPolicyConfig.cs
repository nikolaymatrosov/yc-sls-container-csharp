...
namespace yandex.FunctionScalingPolicy
{
    ...
    [JsiiByValue(fqn: "yandex.functionScalingPolicy.FunctionScalingPolicyConfig")]
    public class FunctionScalingPolicyConfig : yandex.FunctionScalingPolicy.IFunctionScalingPolicyConfig
    {
