...
{
    [JsiiInterface(nativeType: typeof(IVpcSecurityGroupRuleConfig), fullyQualifiedName: "yandex.vpcSecurityGroupRule.VpcSecurityGroupRuleConfig")]
    public interface IVpcSecurityGroupRuleConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        yandex.VpcSecurityGroupRule.IVpcSecurityGroupRuleTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IVpcSecurityGroupRuleConfig), fullyQualifiedName: "yandex.vpcSecurityGroupRule.VpcSecurityGroupRuleConfig")]
        internal sealed class _Proxy : DeputyBase, yandex.VpcSecurityGroupRule.IVpcSecurityGroupRuleConfig
        {
            ...
            {
                get => GetInstanceProperty<yandex.VpcSecurityGroupRule.IVpcSecurityGroupRuleTimeouts?>();
            }
