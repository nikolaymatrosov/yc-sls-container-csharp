...
namespace yandex.MdbMongodbCluster
{
    ...
    [JsiiByValue(fqn: "yandex.mdbMongodbCluster.MdbMongodbClusterConfig")]
    public class MdbMongodbClusterConfig : yandex.MdbMongodbCluster.IMdbMongodbClusterConfig
    {
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(yandex.MdbMongodbCluster.IMdbMongodbClusterDatabase).FullName}[]; received null", nameof(value));
                        default:
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(yandex.MdbMongodbCluster.IMdbMongodbClusterHost).FullName}[]; received null", nameof(value));
                        default:
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(yandex.MdbMongodbCluster.IMdbMongodbClusterUser).FullName}[]; received null", nameof(value));
                        default:
