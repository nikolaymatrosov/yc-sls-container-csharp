...
namespace yandex.LockboxSecretVersion
{
    ...
    [JsiiByValue(fqn: "yandex.lockboxSecretVersion.LockboxSecretVersionConfig")]
    public class LockboxSecretVersionConfig : yandex.LockboxSecretVersion.ILockboxSecretVersionConfig
    {
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(yandex.LockboxSecretVersion.ILockboxSecretVersionEntries).FullName}[]; received null", nameof(value));
                        default:
