...
{
    [JsiiByValue(fqn: "yandex.computeInstanceGroup.ComputeInstanceGroupLoadBalancer")]
    public class ComputeInstanceGroupLoadBalancer : yandex.ComputeInstanceGroup.IComputeInstanceGroupLoadBalancer
    {
