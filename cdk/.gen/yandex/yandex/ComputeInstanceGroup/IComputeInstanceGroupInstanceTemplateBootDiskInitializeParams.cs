...
{
    [JsiiInterface(nativeType: typeof(IComputeInstanceGroupInstanceTemplateBootDiskInitializeParams), fullyQualifiedName: "yandex.computeInstanceGroup.ComputeInstanceGroupInstanceTemplateBootDiskInitializeParams")]
    public interface IComputeInstanceGroupInstanceTemplateBootDiskInitializeParams
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IComputeInstanceGroupInstanceTemplateBootDiskInitializeParams), fullyQualifiedName: "yandex.computeInstanceGroup.ComputeInstanceGroupInstanceTemplateBootDiskInitializeParams")]
        internal sealed class _Proxy : DeputyBase, yandex.ComputeInstanceGroup.IComputeInstanceGroupInstanceTemplateBootDiskInitializeParams
        {
