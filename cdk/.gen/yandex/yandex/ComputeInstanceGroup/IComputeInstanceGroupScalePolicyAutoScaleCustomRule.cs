...
{
    [JsiiInterface(nativeType: typeof(IComputeInstanceGroupScalePolicyAutoScaleCustomRule), fullyQualifiedName: "yandex.computeInstanceGroup.ComputeInstanceGroupScalePolicyAutoScaleCustomRule")]
    public interface IComputeInstanceGroupScalePolicyAutoScaleCustomRule
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IComputeInstanceGroupScalePolicyAutoScaleCustomRule), fullyQualifiedName: "yandex.computeInstanceGroup.ComputeInstanceGroupScalePolicyAutoScaleCustomRule")]
        internal sealed class _Proxy : DeputyBase, yandex.ComputeInstanceGroup.IComputeInstanceGroupScalePolicyAutoScaleCustomRule
        {
