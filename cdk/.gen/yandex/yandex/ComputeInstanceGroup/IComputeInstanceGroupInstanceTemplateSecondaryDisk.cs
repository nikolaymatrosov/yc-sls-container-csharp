...
{
    [JsiiInterface(nativeType: typeof(IComputeInstanceGroupInstanceTemplateSecondaryDisk), fullyQualifiedName: "yandex.computeInstanceGroup.ComputeInstanceGroupInstanceTemplateSecondaryDisk")]
    public interface IComputeInstanceGroupInstanceTemplateSecondaryDisk
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "initializeParams", typeJson: "{\"fqn\":\"yandex.computeInstanceGroup.ComputeInstanceGroupInstanceTemplateSecondaryDiskInitializeParams\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        yandex.ComputeInstanceGroup.IComputeInstanceGroupInstanceTemplateSecondaryDiskInitializeParams? InitializeParams
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IComputeInstanceGroupInstanceTemplateSecondaryDisk), fullyQualifiedName: "yandex.computeInstanceGroup.ComputeInstanceGroupInstanceTemplateSecondaryDisk")]
        internal sealed class _Proxy : DeputyBase, yandex.ComputeInstanceGroup.IComputeInstanceGroupInstanceTemplateSecondaryDisk
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "initializeParams", typeJson: "{\"fqn\":\"yandex.computeInstanceGroup.ComputeInstanceGroupInstanceTemplateSecondaryDiskInitializeParams\"}", isOptional: true)]
            public yandex.ComputeInstanceGroup.IComputeInstanceGroupInstanceTemplateSecondaryDiskInitializeParams? InitializeParams
            {
