...
{
    [JsiiInterface(nativeType: typeof(IComputeInstanceGroupInstanceTemplateNetworkInterfaceDnsRecord), fullyQualifiedName: "yandex.computeInstanceGroup.ComputeInstanceGroupInstanceTemplateNetworkInterfaceDnsRecord")]
    public interface IComputeInstanceGroupInstanceTemplateNetworkInterfaceDnsRecord
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IComputeInstanceGroupInstanceTemplateNetworkInterfaceDnsRecord), fullyQualifiedName: "yandex.computeInstanceGroup.ComputeInstanceGroupInstanceTemplateNetworkInterfaceDnsRecord")]
        internal sealed class _Proxy : DeputyBase, yandex.ComputeInstanceGroup.IComputeInstanceGroupInstanceTemplateNetworkInterfaceDnsRecord
        {
