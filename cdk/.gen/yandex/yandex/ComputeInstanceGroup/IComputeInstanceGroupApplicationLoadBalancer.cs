...
{
    [JsiiInterface(nativeType: typeof(IComputeInstanceGroupApplicationLoadBalancer), fullyQualifiedName: "yandex.computeInstanceGroup.ComputeInstanceGroupApplicationLoadBalancer")]
    public interface IComputeInstanceGroupApplicationLoadBalancer
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IComputeInstanceGroupApplicationLoadBalancer), fullyQualifiedName: "yandex.computeInstanceGroup.ComputeInstanceGroupApplicationLoadBalancer")]
        internal sealed class _Proxy : DeputyBase, yandex.ComputeInstanceGroup.IComputeInstanceGroupApplicationLoadBalancer
        {
