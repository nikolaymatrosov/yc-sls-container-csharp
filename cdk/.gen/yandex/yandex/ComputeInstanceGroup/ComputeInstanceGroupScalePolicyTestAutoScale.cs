...
namespace yandex.ComputeInstanceGroup
{
    ...
    [JsiiByValue(fqn: "yandex.computeInstanceGroup.ComputeInstanceGroupScalePolicyTestAutoScale")]
    public class ComputeInstanceGroupScalePolicyTestAutoScale : yandex.ComputeInstanceGroup.IComputeInstanceGroupScalePolicyTestAutoScale
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "customRule", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"yandex.computeInstanceGroup.ComputeInstanceGroupScalePolicyTestAutoScaleCustomRule\"},\"kind\":\"array\"}}]}}", isOptional: true)]
