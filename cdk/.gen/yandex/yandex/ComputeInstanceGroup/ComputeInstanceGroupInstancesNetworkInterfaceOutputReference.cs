...
namespace yandex.ComputeInstanceGroup
{
    ...
    public class ComputeInstanceGroupInstancesNetworkInterfaceOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        protected ComputeInstanceGroupInstancesNetworkInterfaceOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected ComputeInstanceGroupInstancesNetworkInterfaceOutputReference(DeputyProps props): base(props)
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"yandex.computeInstanceGroup.ComputeInstanceGroupInstancesNetworkInterface\"}", isOptional: true)]
        public virtual yandex.ComputeInstanceGroup.IComputeInstanceGroupInstancesNetworkInterface? InternalValue
        {
            get => GetInstanceProperty<yandex.ComputeInstanceGroup.IComputeInstanceGroupInstancesNetworkInterface?>();
