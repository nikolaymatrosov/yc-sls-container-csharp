...
namespace yandex.ComputeInstanceGroup
{
    ...
    public class ComputeInstanceGroupInstanceTemplateNetworkInterfaceDnsRecordOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        protected ComputeInstanceGroupInstanceTemplateNetworkInterfaceDnsRecordOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected ComputeInstanceGroupInstanceTemplateNetworkInterfaceDnsRecordOutputReference(DeputyProps props): base(props)
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"yandex.computeInstanceGroup.ComputeInstanceGroupInstanceTemplateNetworkInterfaceDnsRecord\"},{\"fqn\":\"cdktf.IResolvable\"}]}}", isOptional: true)]
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case null:
                            break;
                        default:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(yandex.ComputeInstanceGroup.IComputeInstanceGroupInstanceTemplateNetworkInterfaceDnsRecord).FullName}, {typeof(HashiCorp.Cdktf.IResolvable).FullName}; received {value.GetType().FullName}", nameof(value));
                    }
                }
                SetInstanceProperty(value);
            }
