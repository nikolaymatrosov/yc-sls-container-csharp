...
namespace yandex.MdbRedisCluster
{
    ...
    [JsiiByValue(fqn: "yandex.mdbRedisCluster.MdbRedisClusterConfig")]
    public class MdbRedisClusterConfig : yandex.MdbRedisCluster.IMdbRedisClusterConfig
    {
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(HashiCorp.Cdktf.IResolvable).FullName}, {typeof(yandex.MdbRedisCluster.IMdbRedisClusterHost).FullName}[]; received null", nameof(value));
                        default:
