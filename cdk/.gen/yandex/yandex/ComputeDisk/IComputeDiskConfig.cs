...
{
    [JsiiInterface(nativeType: typeof(IComputeDiskConfig), fullyQualifiedName: "yandex.computeDisk.ComputeDiskConfig")]
    public interface IComputeDiskConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        yandex.ComputeDisk.IComputeDiskDiskPlacementPolicy? DiskPlacementPolicy
        {
            get
            {
                return null;
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        yandex.ComputeDisk.IComputeDiskTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IComputeDiskConfig), fullyQualifiedName: "yandex.computeDisk.ComputeDiskConfig")]
        internal sealed class _Proxy : DeputyBase, yandex.ComputeDisk.IComputeDiskConfig
        {
            ...
            {
                get => GetInstanceProperty<yandex.ComputeDisk.IComputeDiskTimeouts?>();
            }
