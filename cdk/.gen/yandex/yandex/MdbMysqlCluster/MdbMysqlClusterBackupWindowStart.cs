...
{
    [JsiiByValue(fqn: "yandex.mdbMysqlCluster.MdbMysqlClusterBackupWindowStart")]
    public class MdbMysqlClusterBackupWindowStart : yandex.MdbMysqlCluster.IMdbMysqlClusterBackupWindowStart
    {
