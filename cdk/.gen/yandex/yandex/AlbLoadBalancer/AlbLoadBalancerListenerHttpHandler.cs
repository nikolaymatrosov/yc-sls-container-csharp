...
{
    [JsiiByValue(fqn: "yandex.albLoadBalancer.AlbLoadBalancerListenerHttpHandler")]
    public class AlbLoadBalancerListenerHttpHandler : yandex.AlbLoadBalancer.IAlbLoadBalancerListenerHttpHandler
    {
