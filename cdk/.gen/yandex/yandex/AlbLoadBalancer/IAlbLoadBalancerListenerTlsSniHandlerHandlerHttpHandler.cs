...
{
    [JsiiInterface(nativeType: typeof(IAlbLoadBalancerListenerTlsSniHandlerHandlerHttpHandler), fullyQualifiedName: "yandex.albLoadBalancer.AlbLoadBalancerListenerTlsSniHandlerHandlerHttpHandler")]
    public interface IAlbLoadBalancerListenerTlsSniHandlerHandlerHttpHandler
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        yandex.AlbLoadBalancer.IAlbLoadBalancerListenerTlsSniHandlerHandlerHttpHandlerHttp2Options? Http2Options
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IAlbLoadBalancerListenerTlsSniHandlerHandlerHttpHandler), fullyQualifiedName: "yandex.albLoadBalancer.AlbLoadBalancerListenerTlsSniHandlerHandlerHttpHandler")]
        internal sealed class _Proxy : DeputyBase, yandex.AlbLoadBalancer.IAlbLoadBalancerListenerTlsSniHandlerHandlerHttpHandler
        {
