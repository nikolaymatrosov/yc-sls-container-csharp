...
{
    [JsiiInterface(nativeType: typeof(IAlbLoadBalancerListenerHttpHandler), fullyQualifiedName: "yandex.albLoadBalancer.AlbLoadBalancerListenerHttpHandler")]
    public interface IAlbLoadBalancerListenerHttpHandler
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "http2Options", typeJson: "{\"fqn\":\"yandex.albLoadBalancer.AlbLoadBalancerListenerHttpHandlerHttp2Options\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        yandex.AlbLoadBalancer.IAlbLoadBalancerListenerHttpHandlerHttp2Options? Http2Options
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IAlbLoadBalancerListenerHttpHandler), fullyQualifiedName: "yandex.albLoadBalancer.AlbLoadBalancerListenerHttpHandler")]
        internal sealed class _Proxy : DeputyBase, yandex.AlbLoadBalancer.IAlbLoadBalancerListenerHttpHandler
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "http2Options", typeJson: "{\"fqn\":\"yandex.albLoadBalancer.AlbLoadBalancerListenerHttpHandlerHttp2Options\"}", isOptional: true)]
            public yandex.AlbLoadBalancer.IAlbLoadBalancerListenerHttpHandlerHttp2Options? Http2Options
            {
