...
namespace yandex.MdbPostgresqlDatabase
{
    ...
    [JsiiByValue(fqn: "yandex.mdbPostgresqlDatabase.MdbPostgresqlDatabaseConfig")]
    public class MdbPostgresqlDatabaseConfig : yandex.MdbPostgresqlDatabase.IMdbPostgresqlDatabaseConfig
    {
