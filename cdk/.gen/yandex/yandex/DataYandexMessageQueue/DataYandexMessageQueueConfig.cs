...
namespace yandex.DataYandexMessageQueue
{
    ...
    [JsiiByValue(fqn: "yandex.dataYandexMessageQueue.DataYandexMessageQueueConfig")]
    public class DataYandexMessageQueueConfig : yandex.DataYandexMessageQueue.IDataYandexMessageQueueConfig
    {
