...
namespace yandex.MdbClickhouseCluster
{
    ...
    [JsiiByValue(fqn: "yandex.mdbClickhouseCluster.MdbClickhouseClusterMlModel")]
    public class MdbClickhouseClusterMlModel : yandex.MdbClickhouseCluster.IMdbClickhouseClusterMlModel
    {
