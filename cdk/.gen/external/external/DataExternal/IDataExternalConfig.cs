...
{
    [JsiiInterface(nativeType: typeof(IDataExternalConfig), fullyQualifiedName: "external.dataExternal.DataExternalConfig")]
    public interface IDataExternalConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        /// <summary>A list of strings, whose first element is the program to run and whose subsequent elements are optional command line arguments to the program.</summary>
        /// <remarks>
        ...
        /// <summary>Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/external/d/external#id DataExternal#id}.</summary>
        /// <remarks>
        ...
        /// <summary>A map of string values to pass to the external program as the query arguments.</summary>
        /// <remarks>
        ...
        /// <summary>Working directory of the program. If not supplied, the program will run in the current directory.</summary>
        /// <remarks>
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataExternalConfig), fullyQualifiedName: "external.dataExternal.DataExternalConfig")]
        internal sealed class _Proxy : DeputyBase, external.DataExternal.IDataExternalConfig
        {
